...
import { Layout, Shield, Upload } from "lucide-react";
import { Progress } from "@/components/ui/progress";
import UploadPdfDialog from "./NewArticleDialog";
  ...
  return (
    <div className="shadow-lg h-screen p-7">
      ...
      <div className="absolute bottom-20 w-[80%]">
        ...
        <p className="text-xs  text-gray-400 mt-1">Upgrade to uplad more PDF</p>
      </div>
    </div>
  );
}
